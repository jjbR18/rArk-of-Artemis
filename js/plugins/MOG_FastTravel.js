...
// ** TOWNS
//=============================================================================	
	Moghunter.fastTravel_Towns[1] = {name:"港口城市格兰菲利亚",x:2460,y:1214,mapID:95,mapX:17,mapY:3,direction:2};
    Moghunter.fastTravel_Towns[2] = {name:"中枢都市巴尔",x:2830,y:1705,mapID:97,mapX:24,mapY:26,direction:8};
　　Moghunter.fastTravel_Towns[3] = {name:"中枢都市巴尔",x:2830,y:1705,mapID:76,mapX:24,mapY:26,direction:8};
	Moghunter.fastTravel_Towns[4] = {name:"中枢都市巴尔",x:2830,y:1705,mapID:45,mapX:24,mapY:26,direction:8};
	Moghunter.fastTravel_Towns[5] = {name:"中枢都市巴尔",x:2830,y:1705,mapID:53,mapX:24,mapY:26,direction:8};

//=============================================================================
// ** DUNGEONS
//=============================================================================	
	Moghunter.fastTravelDungeons[1] = {name:"神护之森",x:2467,y:1460,mapID:104,mapX:51,mapY:3,direction:2};
    Moghunter.fastTravelDungeons[2] = {name:"幻兽之森",x:2290,y:1675,mapID:87,mapX:6,mapY:36,direction:8};
    Moghunter.fastTravelDungeons[3] = {name:"热砂洞窟",x:2589,y:2145,mapID:169,mapX:12,mapY:17,direction:8};
	Moghunter.fastTravelDungeons[4] = {name:"魔矿山",x:1806,y:1152.,mapID:11,mapX:12,mapY:22,direction:8};	
	Moghunter.fastTravelDungeons[5] = {name:"星咏之森",x:3128,y:2053,mapID:12,mapX:20,mapY:78,direction:8};
	Moghunter.fastTravelDungeons[6] = {name:"圣域",x:900,y:982,mapID:16,mapX:38,mapY:30,direction:4};
	
	 
//=============================================================================
// ** OTHER
//=============================================================================	
	Moghunter.fastTravelOther[1] = {name:"回想之馆",x:2130,y:1014,mapID:142,mapX:13,mapY:4,direction:2};
