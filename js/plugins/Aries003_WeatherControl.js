 ...
 * ★ Aries003_WeatherControl ★                                        1.0.2
 * ----------------------------------------------------------------------------
 * Fine-tune in-game weather with various customizable features.
 * 
 * This plugin allows you to control the look and feel of in-game weather
 * by providing controls to speed, angle, size, and image for the 3 built-in
 * weather effects present in RPG Maker MV.
 * 
 * Furthermore, the plugin allows you to define the minimum and maximum sprite
 * counts for each weather type, and automates thunder effects during a storm.
 * 
 * ----------------------------------------------------------------------------
 ...
 * ----------------------------------------------------------------------------
 * ◆ 06 Sep 2019
 * 1.0.2    -    Added dimmer color parameters.
 *          -    Fixed a crash occuring in which parameters were read incorrectly.
 *          -    De-obfuscated code!
 * ◆ 04 Jul 2019
 * 1.0.1    -    Added dimmer control parameters.
 *          -    Adjusted sprite erase positions.
 * ◆ 16 May 2019
 * 1.0.0    -    Release
 * ----------------------------------------------------------------------------
 * 
 ...
 * @default 
 * 
 * @param Rain Screen Tone Power
 * @parent Rain
 * @type number
 * @min 0
 * @max 255
 * @desc Determine the strength of the screen dim during rain.
 * Valid: A number between 0 to 255
 * @default 40
 * 
 * @param Rain Screen Tone Color
 * @parent Rain
 * @desc Determine the color of the screen dim during rain.
 ...
 * @default 
 * 
 * @param Storm Screen Tone Power
 * @parent Storm
 * @type number
 * @min 0
 * @max 255
 * @desc Determine the strength of the screen dim during a storm.
 * Valid: A number between 0 to 255
 * @default 60
 * 
 * @param Storm Screen Tone Color
 * @parent Storm
 * @desc Determine the color of the screen dim during a storm.
 * Valid: [red, green, blue]
 * @default [33, 35, 39]
 * 
 ...
 * @default 
 * 
 * @param Snow Screen Tone Power
 * @parent Snow
 * @type number
 * @min 0
 * @max 255
 * @desc Determine the strength of the screen dim during snow.
 * Valid: A number between 0 to 255
 * @default 33
 * 
 * @param Snow Screen Tone Color
 * @parent Snow
 * @desc Determine the color of the screen dim during snow.
 * Valid: [red, green, blue]
 * @default [108, 109, 111]
 * 
 ...
 * @default Leaf
 * 
 * @param Leaf Screen Tone Power
 * @parent Leaf
 * @type number
 * @min 0
 * @max 255
 * @desc Determine the strength of the screen dim while leaves fall.
 * Valid: A number between 0 to 255
 * @default 0
 * 
 * @param Leaf Screen Tone Color
 * @parent Leaf
 * @desc Determine the color of the screen dim while leaves fall.
 * Valid: [red, green, blue]
 * @default [0, 0, 0]
 * 
 ...
 * @default Embers
 * 
 * @param Embers Screen Tone Power
 * @parent Embers
 * @type number
 * @min 0
 * @max 255
 * @desc Determine the strength of the screen dim while during Embers.
 * Valid: A number between 0 to 255
 * @default 0
 * 
 * @param Embers Screen Tone Color
 * @parent Embers
 * @desc Determine the color of the screen dim while during Embers.
 * Valid: [red, green, blue]
 * @default [255, 223, 12]
 * 
 ...
 * @default Shine
 * 
 * @param Shine Screen Tone Power
 * @parent Shine
 * @type number
 * @min 0
 * @max 255
 * @desc Determine the strength of the screen dim while during Shine.
 * Valid: A number between 0 to 255
 * @default 0
 * 
 * @param Shine Screen Tone Color
 * @parent Shine
 * @desc Determine the color of the screen dim while during Shine.
 * Valid: [red, green, blue]
 * @default [255, 128, 255]
 * 
...
Aries.P003_WCT.RainDim    = Number(Aries.P003_WCT.Param["Rain Screen Tone Power"]);
Aries.P003_WCT.RainTone   = eval(Aries.P003_WCT.Param["Rain Screen Tone Color"]);
...
Aries.P003_WCT.StormDim    = Number(Aries.P003_WCT.Param["Storm Screen Tone Power"]);
Aries.P003_WCT.StormTone   = eval(Aries.P003_WCT.Param["Storm Screen Tone Color"]);
...
Aries.P003_WCT.SnowDim    = Number(Aries.P003_WCT.Param["Snow Screen Tone Power"]);
Aries.P003_WCT.SnowTone   = eval(Aries.P003_WCT.Param["Snow Screen Tone Color"]);
...
Aries.P003_WCT.LeafDim    = Number(Aries.P003_WCT.Param["Leaf Screen Tone Power"]);
Aries.P003_WCT.LeafTone   = eval(Aries.P003_WCT.Param["Leaf Screen Tone Color"]);
...
Aries.P003_WCT.HeatDim    = Number(Aries.P003_WCT.Param["Embers Screen Tone Power"]);
Aries.P003_WCT.MysticTone   = eval(Aries.P003_WCT.Param["Embers Screen Tone Color"]);
...
Aries.P003_WCT.MysticDim    = Number(Aries.P003_WCT.Param["Shine Screen Tone Power"]);
Aries.P003_WCT.MysticTone   = eval(Aries.P003_WCT.Param["Shine Screen Tone Color"]);

Aries.P003_WCT.DimmerColorTone = 0;
Aries.P003_WCT.DimmerIntensity = 0;
...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    ...
    } else if (command === 'AriesSetToneColor') {
        Aries.P003_WCT.setDimmerColor(eval(args[0]));
    } else if (command === 'AriesSetTonePower') {
        Aries.P003_WCT.setDimmerPower(args[0]);
    }
};
...
Aries.P003_WCT.setDimmerColor = function(r, g, b) {
    Aries.P003_WCT.DimmerColorTone = [r, g, b];
};

Aries.P003_WCT.setDimmerPower = function(a) {
    Aries.P003_WCT.DimmerIntensity = a;
};
...
Game_Screen.prototype.updateStorm = function() {
    ...
    if (this._stormThunderCount <= 0) {
        ...
        thunderSound = {name: Aries.P003_WCT.ThunderSound,
                        pan: 0,
                        pitch: (Aries.P003_WCT.ThunderSEPitch - Aries.P003_WCT.ThunderSEPitchV) + Math.randomInt(1 + Aries.P003_WCT.ThunderSEPitchV * 2),
                        volume: Aries.P003_WCT.ThunderSEVol};
...
Weather.prototype._setDimmerColor = function(color) {
    this._dimmerSprite.setColor(color[0], color[1], color[2]);
};

Weather.prototype._updateDimmer = function() {
    switch (this.type) {
        case 'rain':
            var r = Aries.P003_WCT.RainTone[0];
            var g = Aries.P003_WCT.RainTone[1];
            var b = Aries.P003_WCT.RainTone[2];
            var dimPower = Aries.P003_WCT.RainDim;
            break;
        case 'storm':
            var r = Aries.P003_WCT.StormTone[0];
            var g = Aries.P003_WCT.StormTone[1];
            var b = Aries.P003_WCT.StormTone[2];
            var dimPower = Aries.P003_WCT.StormDim;
            break;
        case 'snow':
            var r = Aries.P003_WCT.SnowTone[0];
            var g = Aries.P003_WCT.SnowTone[1];
            var b = Aries.P003_WCT.SnowTone[2];
            var dimPower = Aries.P003_WCT.SnowDim;
            break;
        case 'leaves':
            var r = Aries.P003_WCT.LeafTone[0];
            var g = Aries.P003_WCT.LeafTone[1];
            var b = Aries.P003_WCT.LeafTone[2];
            var dimPower = Aries.P003_WCT.LeafDim;
            break;
        case 'embers':
            var r = Aries.P003_WCT.HeatTone[0];
            var g = Aries.P003_WCT.HeatTone[1];
            var b = Aries.P003_WCT.HeatTone[2];
            var dimPower = Aries.P003_WCT.HeatDim;
            break;
        case 'shine':
            var r = Aries.P003_WCT.MysticTone[0];
            var g = Aries.P003_WCT.MysticTone[1];
            var b = Aries.P003_WCT.MysticTone[2];
            var dimPower = Aries.P003_WCT.MysticDim;
            break;
        }
    this._setDimmerColor([r, g, b]);
    this._dimmerSprite.opacity = Math.floor((0.1 * this.power) * dimPower * Aries.P003_WCT.DimmerIntensity);
};
...
Spriteset_Base.prototype.updateScreenEffects = function() {
    ...
    if (this._wct_glow_filter) {
        switch ($gameScreen.weatherType()) {
            ...
            case 'embers':
                this._wct_glow_filter.enabled = true;
                this._wct_glow_filter.bloomScale = 0.2 + (0.015 * $gameScreen.weatherPower()); + 0.2 * (1 + Math.sin(0.03 * Graphics.frameCount));
